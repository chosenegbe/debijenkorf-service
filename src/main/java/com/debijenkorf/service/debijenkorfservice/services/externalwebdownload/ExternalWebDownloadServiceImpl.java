package com.debijenkorf.service.debijenkorfservice.services.externalwebdownload;
...
@Service
public class ExternalWebDownloadServiceImpl implements ExternalWebDownloadService {
    ...
    public File download(String fileName)  {
        ...
        String urlTemplate = externalServerUrl + "/"+ fileName;
        ...
        LOG.info("Download of file " + fileName + " completed. File downloaded from " + externalServerUrl);
